...
export default function Demo() {
  ...
  const demoResponses: Record<string, string> = {
    ...
    'features': 'BotFusion allows you to create AI chatbots from your website or PDF content. Key features include customizable appearance, one-line JavaScript integration, and an analytics dashboard.',
    'how it works': 'BotFusion works in 4 simple steps: 1) Input your website URL or PDF, 2) Our AI analyzes your content, 3) Customize your chatbot appearance, 4) Add a single line of JavaScript to your website.',
    'integration': 'Integrating BotFusion is simple! Just add one line of JavaScript to your website\'s HTML. The code will look something like: <script src="https://botfusion.ai/js/widget.js?id=YOUR_BOT_ID"></script>',
    ...
    <div id="demo" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          ...
          <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">See BotFusion in action</p>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
            Try our interactive demo to experience how your AI chatbot will work on your website.
          </p>
        </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="mt-6 text-sm text-gray-500">
                Note: This is a simplified demo. Your actual BotFusion chatbot will be trained on your specific website content or PDF documents.
              </p>
            </div>
          </div>
