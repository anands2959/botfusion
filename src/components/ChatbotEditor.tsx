              ...
              <div className="grid grid-cols-1 gap-6">
                <div>
                  ...
                  <input
                    ...
                    id="name"
                    value={name}
                    onChange={(e) => setName(e.target.value || 'BotFusion')}
                  ...
                  >
                    ...
                    <div className="p-3 border-t border-gray-200">
                      <div className="flex rounded-md shadow-sm">
                        <input
                          type="text"
                          className="flex-1 p-2 text-gray-700 focus:ring-blue-500 focus:border-blue-500 block w-full rounded-md sm:text-sm border-gray-300"
                          placeholder="Type your message..."
                          disabled
                        />
                        <button
                          type="button"
                          className="ml-3 inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white"
                          style={{ backgroundColor: colorScheme }}
                          disabled
                        >
