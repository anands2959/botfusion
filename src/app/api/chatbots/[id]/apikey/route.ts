...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const embedScript = `<script src="${process.env.NEXT_PUBLIC_APP_URL || 'https://botfusion.vercel.app'}/embed.js" data-chatbot-id="${apiKey}"></script>`;
...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    if (chatbot.apiKey) {
      embedScript = `<script src="${process.env.NEXT_PUBLIC_APP_URL || 'https://botfusion.vercel.app'}/embed.js" data-chatbot-id="${chatbot.apiKey}"></script>`;
    }
